...
function InlineCTA() {
  return (
    <div className="my-10 rounded-xl border border-indigo-100 bg-indigo-50 px-6 py-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
      <div>
      ...
      <Link
        href="/generate"
        className="shrink-0 rounded-lg bg-indigo-600 px-5 py-2.5 text-sm font-semibold text-white hover:bg-indigo-700 transition-colors"
      >
...
export default function GuidePage() {
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Hero */}
      <section className="px-4 py-16 sm:px-6 lg:px-8 border-b border-gray-100">
        ...
        <div className="mx-auto max-w-3xl space-y-16">
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              ...
              <p>
                Great briefs share three qualities: <strong className="text-gray-800">clarity</strong>{' '}
                (everyone reading it arrives at the same understanding),{' '}
                <strong className="text-gray-800">constraint</strong> (it closes off wrong directions
                so creative energy flows in the right ones), and{' '}
                <strong className="text-gray-800">tension</strong> (it presents a problem worth
          ...
          <section>
            ...
            <div className="border-l-4 border-indigo-500 pl-6 mb-10">
              <h3 className="text-xl font-bold text-gray-900 mb-2">1. Objective</h3>
            ...
            {/* Element 2 */}
            <div className="border-l-4 border-indigo-500 pl-6 mb-10">
              <h3 className="text-xl font-bold text-gray-900 mb-2">2. Audience</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            {/* Element 3 */}
            <div className="border-l-4 border-indigo-500 pl-6 mb-10">
              <h3 className="text-xl font-bold text-gray-900 mb-2">3. Deliverables</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            {/* Element 4 */}
            <div className="border-l-4 border-indigo-500 pl-6 mb-10">
              <h3 className="text-xl font-bold text-gray-900 mb-2">4. Tone</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            {/* Element 5 */}
            <div className="border-l-4 border-indigo-500 pl-6 mb-10">
              <h3 className="text-xl font-bold text-gray-900 mb-2">5. Budget</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            {/* Element 6 */}
            <div className="border-l-4 border-indigo-500 pl-6 mb-10">
              <h3 className="text-xl font-bold text-gray-900 mb-2">6. Timeline</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            {/* Element 7 */}
            <div className="border-l-4 border-indigo-500 pl-6 mb-10">
              <h3 className="text-xl font-bold text-gray-900 mb-2">7. KPIs</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            {/* Element 8 */}
            <div className="border-l-4 border-indigo-500 pl-6 mb-10">
              <h3 className="text-xl font-bold text-gray-900 mb-2">8. Brand Context</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="mb-10">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="rounded-lg bg-red-50 border border-red-100 p-4">
                  <p className="text-xs font-bold text-red-600 uppercase tracking-wide mb-2">Bad</p>
                ...
                <div className="rounded-lg bg-green-50 border border-green-100 p-4">
                  <p className="text-xs font-bold text-green-600 uppercase tracking-wide mb-2">Good</p>
                  <p className="text-sm text-gray-700 leading-relaxed">
          ...
          <section className="rounded-2xl bg-gray-900 text-white px-8 py-12 text-center">
            ...
            <Link
              href="/generate"
              className="inline-block rounded-lg bg-indigo-500 px-8 py-4 text-base font-semibold text-white hover:bg-indigo-400 transition-colors"
            >
              Check your brief with AIDEN — it&apos;s free
            </Link>
            <p className="text-gray-500 text-sm mt-4">No account needed to start.</p>
          </section>
