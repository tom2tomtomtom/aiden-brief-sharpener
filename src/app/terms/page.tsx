      ...
      <section className="px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="space-y-10 text-sm text-white-muted leading-relaxed">
            ...
            <div>
              <h2 className="text-lg font-semibold text-white uppercase mb-3">3. No Warranty on Conversion Rates</h2>
              <p>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li><strong className="text-white">Single ($19 one-time):</strong> A single generation with no attribution footer. This is a one-time charge &mdash; you will not be billed again.</li>
                <li><strong className="text-white">Pro ($39/month):</strong> Unlimited generations billed monthly. You can cancel at any time; cancellation takes effect at the end of the current billing period.</li>
              </ul>
              <p className="mt-3">
